\newpage
\anonsection{Приложение A. Устройство для измерения угла положения и линейного перемещения контролируемого объекта ИЗ №2780031}\label{sec:applicationA}
\begin{figure}[!h]
    \centering
...
\anonsection{Приложение Б. Преобразователь угловых перемещений ПМ №175216}\label{sec:applicationB}
...
\end{figure}
\newpage
\anonsection{Приложение В. Преобразователь угловых перемещений ИЗ №2120105}\label{sec:applicationW}
\begin{figure}[!h]
    \centering
